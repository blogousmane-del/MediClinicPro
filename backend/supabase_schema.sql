...
CREATE TABLE payments (
  ...
  provider TEXT DEFAULT 'manual', -- manual, bictorys, paytech
...
CREATE TABLE subscription_payments (
  ...
  amount REAL NOT NULL,
  provider TEXT NOT NULL, -- bictorys, paytech
  provider_reference TEXT,
  checkout_url TEXT,
...
-- 15. Payment Webhook Events Table (dedup for Bictorys/PayTech webhook retries)
